...
// Navigation Items for Admin Dashboard based on Assignment Spec
const adminNavItems = [
    {
        name: "Overview",
    ...
    {
        name: "Manage Lawyer Listings",
        href: "/dashboard/admin/lawyer-listings",
        icon: FaListUl,
    },
    {
...
// Main Admin Dashboard Sidebar Component
                        ...
                        {(!collapsed || isMobile) && (
                            <div className="flex flex-col truncate">
                                ...
                                <span className="text-[11px] text-text-secondary truncate flex items-center gap-1 mt-1">
                                    ...
                                    <p className="uppercase text-[12px]">{user?.role || "Admin"}</p>
                                </span>
                            </div>
                        )}
                    </div>
